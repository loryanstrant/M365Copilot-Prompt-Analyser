    ...
    <div className="card overflow-hidden border-brand-200 dark:border-brand-800/60">
      ...
      {open && (
        <div className="space-y-6 px-6 py-5">
          <div className="rounded-lg border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm dark:border-emerald-800/60 dark:bg-emerald-900/20">
            <p className="font-semibold text-emerald-800 dark:text-emerald-300">
              Already running the M365 Copilot Usage Reporter?
            </p>
            <p className="mt-1 text-emerald-700/90 dark:text-emerald-400/90">
              Reuse its app registration — it already has the exact two Graph
              permissions this analyser needs
              (<span className="font-medium">AiEnterpriseInteraction.Read.All</span> and{" "}
              <span className="font-medium">Directory.Read.All</span>). Just create a
              fresh client secret on that app (Step 3) and paste its Tenant ID, Client
              ID and secret below — you can skip Steps 1–2. Otherwise, create a new
              registration named{" "}
              <span className="font-medium">M365 Copilot Prompt Analyser</span> using
              the steps below.
            </p>
          </div>
          ...
          <Step n={1} title="Create the app registration">
            <p>
              ...
              . Name it <span className="font-medium">M365 Copilot Prompt Analyser</span>,
          ...
          <div className="rounded-lg border border-slate-200 dark:border-slate-700">
            ...
            >
              <span>Prefer to script it? Run this to create a new app registration</span>
