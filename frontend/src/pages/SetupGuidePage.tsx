    ...
    <div className="max-w-4xl space-y-8">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
          Everything needed to connect the analyser to your tenant, and what to check when
      ...
      <div className="card p-6">
        ...
        <ul className="list-inside list-disc space-y-1.5 text-sm text-slate-600 dark:text-slate-300">
          ...
          <li>
            An Azure OpenAI deployment, with its endpoint, key and deployment name ready to
            paste into Settings — the analysis stage cannot run without it.
          </li>
