    ...
    <div className="flex h-full w-full">
      ...
      <div className="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-gradient-to-br from-brand-700 via-brand-600 to-brand-500 p-12 text-white lg:flex">
        ...
        <div className="relative flex items-center gap-3">
          ...
          />
          <span className="text-lg font-semibold">M365 Copilot Prompt Analyser</span>
        </div>
        <div className="relative max-w-md">
          <h1 className="text-3xl font-semibold leading-tight">
            Find out how well your people actually prompt
          </h1>
          <p className="mt-4 text-brand-100">
            Every conversation scored for quality, GCSE levers, sentiment and sensitive
            information — so you can coach the people who need it and prove improvement
            over time.
          </p>
        </div>
