...
export const APP_DISPLAY_NAME = "M365 Copilot Prompt Analyser";

/** Microsoft Graph application permissions this solution needs. */
export const REQUIRED_PERMISSIONS = [
  {
    value: "AiEnterpriseInteraction.Read.All",
    why: "Reads Copilot enterprise interaction history — the prompts that get analysed.",
  },
  {
    value: "Directory.Read.All",
    why: "Resolves users and departments so prompt quality can be grouped and filtered.",
  },
];
