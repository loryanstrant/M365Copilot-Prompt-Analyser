...
class Settings(BaseSettings):
    ...
    # External origin of this deployment, e.g. https://prompts.contoso.com.
    ...
    # --- Analysis tuning --------------------------------------------------
    # Conversations analysed concurrently by the LLM stage. Keep modest to
    # respect Azure OpenAI TPM/RPM quotas.
    analysis_concurrency: int = Field(default=5, alias="ANALYSIS_CONCURRENCY")
    # Run the LLM analysis stage automatically after each ingest.
    analyse_after_ingest: bool = Field(default=True, alias="ANALYSE_AFTER_INGEST")
