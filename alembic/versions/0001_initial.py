...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("name_confidence", sa.Integer(), nullable=True),
        sa.Column("sensitive_confidence", sa.Integer(), nullable=True),
        sa.Column("curse_confidence", sa.Integer(), nullable=True),
        sa.Column(
            "analysed", sa.Boolean(), server_default=sa.false(), nullable=False
        ),
    ...
    op.create_index("ix_prompts_analysed", "prompts", ["analysed"])

    op.create_table(
        "prompt_analysis",
        sa.Column("prompt_id", sa.Text(), primary_key=True),
        sa.Column("conversation_id", sa.Text(), nullable=True),
        sa.Column("user_generated", sa.Boolean(), nullable=True),
        sa.Column("sentiment", sa.Text(), nullable=True),
        sa.Column("quality_score", sa.Integer(), nullable=True),
        sa.Column("quality_rationale", sa.Text(), nullable=True),
        sa.Column("category", sa.Text(), nullable=True),
        sa.Column("gcse_goal", sa.Integer(), nullable=True),
        sa.Column("gcse_context", sa.Integer(), nullable=True),
        sa.Column("gcse_source", sa.Integer(), nullable=True),
        sa.Column("gcse_expectation", sa.Integer(), nullable=True),
        sa.Column(
            "analysed_at",
            sa.DateTime(timezone=True),
            server_default=sa.func.now(),
    ...
    op.create_index(
        "ix_prompt_analysis_conversation_id", "prompt_analysis", ["conversation_id"]
    )
    ...
    op.create_table(
        ...
        sa.Column("sentiment", sa.Text(), nullable=True),
        sa.Column("avg_quality_score", sa.Numeric(4, 1), nullable=True),
        sa.Column("conversation_quality_score", sa.Integer(), nullable=True),
        sa.Column("user_generated_ratio", sa.Float(), nullable=True),
        sa.Column("theme", sa.Text(), nullable=True),
        sa.Column("insight", sa.Text(), nullable=True),
        sa.Column("category", sa.Text(), nullable=True),
        sa.Column("improvement", sa.Text(), nullable=True),
        sa.Column("suggested_starter_prompt", sa.Text(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("aoai_endpoint", sa.Text(), nullable=True),
        sa.Column(
            "aoai_deployment",
            sa.Text(),
            server_default="gpt-5.4-mini",
            nullable=True,
        ),
        sa.Column(
            "aoai_api_version",
            sa.Text(),
            server_default="2025-01-01-preview",
            nullable=True,
        ),
        sa.Column("aoai_key_encrypted", sa.Text(), nullable=True),
        sa.Column(
            "analysis_mode", sa.Text(), server_default="combined", nullable=False
        ),
        sa.Column(
            "updated_at",
            sa.DateTime(timezone=True),
